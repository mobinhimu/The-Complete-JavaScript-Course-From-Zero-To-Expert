...
if (marksHigherBMI) {
  //   console.log(`Marks BMI ${marksBMI} is higher than Jhons ${JhonsBMI} `);
} else {
  //   console.log(`Jhons BMI ${JhonsBMI} is higher than Marks ${JhonsBMI}`);
}
...
const finalValue = `The bill was ${bill}, the tip was ${tip}, and the total value ${
  bill + tip
}`;
